...
inline const vxui_demo_command_deck_theme& vxui_demo_command_deck_theme_tokens()
{
    static constexpr vxui_demo_command_deck_theme theme = {
        ...
        .hero_surface_fill = { 20, 31, 49, 248 },
        .hero_surface_border = { 86, 121, 159, 210 },
        .primary_panel_fill = { 16, 27, 43, 244 },
        .primary_panel_border = { 78, 109, 146, 214 },
        .secondary_panel_fill = { 20, 33, 52, 232 },
        .secondary_panel_border = { 66, 96, 132, 198 },
        .utility_fill = { 13, 22, 35, 248 },
        .utility_border = { 98, 136, 174, 220 },
        .focused_row_fill = { 56, 103, 142, 252 },
        .focused_row_border = { 181, 236, 247, 255 },
        .passive_row_fill = { 18, 29, 46, 234 },
        .passive_row_border = { 94, 123, 159, 182 },
        .badge_fill = { 176, 132, 56, 242 },
        ...
        .surface_scanline_alpha = 0.026f,
        .title_focus_decor_alpha = 0.14f,
        .form_focus_decor_alpha = 0.12f,
    };
    return theme;
}
